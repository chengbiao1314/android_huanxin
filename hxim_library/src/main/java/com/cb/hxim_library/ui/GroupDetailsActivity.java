...
import com.cb.hxim_library.easeui.ui.EaseGroupRemoveListener;
import com.cb.hxim_library.easeui.utils.EaseUserUtils;
import com.cb.hxim_library.easeui.widget.EaseAlertDialog;
import com.cb.hxim_library.easeui.widget.EaseAlertDialog.AlertDialogUser;
import com.cb.hxim_library.easeui.widget.EaseExpandGridView;
...
public class GroupDetailsActivity extends BaseActivity implements OnClickListener {
	...
	public void onClick(View v) {
		if(v.getId() == R.id.rl_switch_block_groupmsg){
			toggleBlockGroup();
		}else if(v.getId() == R.id.clear_all_history){
